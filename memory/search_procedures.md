...
grep -l "current_company: Google" \
  "/Users/eugene/Dropbox/Agents/contact-management-agent/linkedin_contacts/"*.json
```
...
grep -l "at \[\[Google\]\]" \
  "/Users/eugene/Library/CloudStorage/GoogleDrive-eugene@ability.ai/My Drive/ContactsDatabase/Contacts/People/"*.md
```
...
/Users/eugene/Dropbox/Agents/Corbin20/scripts/utilities/search_call_transcripts.py \
  "your query" -n 10
...
/Users/eugene/Dropbox/Agents/Corbin20/scripts/utilities/search_call_transcripts.sh \
  "your query" 10
```
...
cat /Users/eugene/Dropbox/Agents/Corbin20/source-of-truth/sales_process_3.0.md
cat /Users/eugene/Dropbox/Agents/Corbin20/source-of-truth/Q4_2025_OKRs.md
```
...
grep -r "Apollo.io" /Users/eugene/Dropbox/Agents/Corbin20/source-of-truth/
grep -r "AI Copilot ICP" /Users/eugene/Dropbox/Agents/Corbin20/source-of-truth/
```

#### 3D: Browse Structure
```bash
# List all business documentation areas
ls -la /Users/eugene/Dropbox/Agents/Corbin20/source-of-truth/
...
cd /Users/eugene/Dropbox/Agents/Corbin20/source-of-truth
git pull
...
ls -la /Users/eugene/Dropbox/Agents/Corbin20/scripts/
...
grep -r "gmail" /Users/eugene/Dropbox/Agents/Corbin20/scripts/ --include="*.py"
grep -r "Apollo.io" /Users/eugene/Dropbox/Agents/Corbin20/scripts/ --include="*.py"
grep -r "vertex" /Users/eugene/Dropbox/Agents/Corbin20/scripts/ --include="*.py"
```

#### 4D: By Filename Pattern (Glob)
```bash
# Find scripts by naming convention
find /Users/eugene/Dropbox/Agents/Corbin20/scripts/ -name "*enrichment*.py"
find /Users/eugene/Dropbox/Agents/Corbin20/scripts/ -name "*sync*.py"
find /Users/eugene/Dropbox/Agents/Corbin20/scripts/ -name "*mcp*.py"
```
...
head -50 /Users/eugene/Dropbox/Agents/Corbin20/memory/action_log.txt
```
...
**Use when**: Need Eugene's communication style, business info, preferences

```bash
# Targeted jq queries (don't load entire file)
jq '.profile' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
jq '.preferences.communication_style' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
```
...
```bash
jq '.memory.key_facts' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
jq '.memory.past_decisions' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
```
...
```bash
jq '.entities.people' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
jq '.entities.projects' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
```
...
```bash
jq '.context.current_task' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
jq '.context.active_topics' /Users/eugene/Dropbox/Agents/Corbin20/memory/memory_index.json
```
...
grep "source-of-truth" /Users/eugene/Dropbox/Agents/Corbin20/memory/file_index.md
grep "scripts" /Users/eugene/Dropbox/Agents/Corbin20/memory/file_index.md
```
...
ls -la /Users/eugene/Dropbox/Agents/Corbin20/project_files/

# Search within specific project
grep -r "keyword" /Users/eugene/Dropbox/Agents/Corbin20/project_files/us_trip_planning/
```
...
ls -lt /Users/eugene/Dropbox/Agents/Corbin20/session-files/ | head -10

# Search recent session files
find /Users/eugene/Dropbox/Agents/Corbin20/session-files/ -name "*.md" -mtime -7
```
...
- **Storage**: Persistent index in `/Users/eugene/Dropbox/Agents/vector-store-project/index/`
