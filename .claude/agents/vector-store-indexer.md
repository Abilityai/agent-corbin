...
**Project folder**: `$AGENTS_DIR/vector-store-project`
...
**Corbin's index location**: `$AGENTS_DIR/vector-store-project/index/`
**Indexed content**: All 5,165 documents in `$AGENTS_DIR/Corbin20`
