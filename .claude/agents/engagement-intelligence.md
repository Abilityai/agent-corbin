...
**Why it failed**:
- <5% signal-to-noise ratio in [User]'s inbox
...
- [User]'s ~8,000 contact database: 99% dormant (LinkedIn connections, mailing lists), 1% active relationships
...
Your role is [User]'s relationship intelligence system. You help ensure:
