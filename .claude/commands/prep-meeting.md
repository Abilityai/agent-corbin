...
## Objective
Prepare [User] for an upcoming meeting by gathering comprehensive context about attendees through cascading research across multiple sources.
...
- Extract all attendee email addresses (excluding your-email@example.com)
...
4. **Actionable insights**: Focus on information that helps [User] prepare, not exhaustive bios
...
Expected outcome: Within 30-60 seconds, [User] receives a comprehensive brief about upcoming meeting with actionable context about each attendee.
